...
Loan::Loan(Member* member, Book* book):borrower(member), borrowed_book(book), loan_status(false){}
...
void Loan::set_borrowingDate(const string& dateInString) { // extract the date in the string and assign it to the borrowing date day, month, year
    // format of the string: 25-4-2024
    string buffer = "";
    int dashCount = 0;
